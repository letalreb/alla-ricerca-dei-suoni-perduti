/**
 * Script per caricare video 88 su Internet Archive
 */
...
const OUTPUT_FILE = path.join(__dirname, '../archive-mapping-88.json');

// Video da caricare
const VIDEO = { id: 88, file: '88_EUGENIO_VIOLINO_migliorato.mp4' };
...
function createIdentifier(id, filename) {
  return `villa-medici-giulini-88-violino-giuseppe-pedrazzini-milano-1920`;
}
...
async function uploadVideo(video) {
  ...
  const title = 'Violino Giuseppe Pedrazzini (1879-1957), Milano, 1920';
  ...
  const args = [
    ...
    '--metadata=description:Violino Giuseppe Pedrazzini (1879-1957), Milano, 1920. Strumento musicale storico della collezione Villa Medici Giulini, Briosco (MB), Italia. Parte del progetto \'Alla ricerca dei suoni perduti\'.',
    '--metadata=subject:musical instruments',
    '--metadata=subject:historical instruments',
    '--metadata=subject:violin',
...
// Funzione principale
async function main() {
  console.log('🏛️  Upload Video 88 su Internet Archive\n');
